...
class CreateWeeklyPlanTaskRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'finca_group_id' =>                 ['sometimes', 'numeric', 'exists:finca_groups,id'],
            'insumos' =>                        ['array'],
            'insumos.*.insumo_id' =>            ['required', 'numeric', 'exists:insumos,id'],
            'insumos.*.assigned_quantity' =>    ['required', 'numeric']
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'insumos.array' => 'El listado de insumos debe ser un arreglo.',

            'insumos.*.insumo_id.required' => 'El insumo es obligatorio.',
            'insumos.*.insumo_id.numeric' => 'El identificador del insumo debe ser numérico.',
            'insumos.*.insumo_id.exists' => 'El insumo seleccionado no existe.',

            'insumos.*.assigned_quantity.required' => 'La cantidad asignada es obligatoria.',
            'insumos.*.assigned_quantity.numeric' => 'La cantidad asignada debe ser un valor numérico.',
        ];
    }
}
